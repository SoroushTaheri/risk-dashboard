...
const nav = [
  { key: "portfolio", label: ["Portfolio", "پرتفوی"], caption: ["Source data and lineage", "داده‌های منبع و زنجیرهٔ ردیابی"], href: "/", icon: CircleGauge },
  ...
  { key: "utility", label: ["Utility & Reinsurance", "مطلوبیت و بیمهٔ اتکایی"], caption: ["Modern Actuarial Risk Theory · Ch. 1", "نظریهٔ مدرن ریسک بیمه‌ای · فصل ۱"], href: "/utility-reinsurance", icon: Scale },
  { key: "individual", label: ["Individual Risk", "مدل ریسک انفرادی"], caption: ["Modern Actuarial Risk Theory · Ch. 2", "نظریهٔ مدرن ریسک بیمه‌ای · فصل ۲"], href: "/individual-risk", icon: Network },
  { key: "collective", label: ["Collective Risk", "مدل ریسک جمعی"], caption: ["Modern Actuarial Risk Theory · Ch. 3", "نظریهٔ مدرن ریسک بیمه‌ای · فصل ۳"], href: "/collective-risk", icon: Activity },
  { key: "ruin", label: ["Solvency & Ruin", "توانگری و ورشکستگی"], caption: ["Modern Actuarial Risk Theory · Ch. 4", "نظریهٔ مدرن ریسک بیمه‌ای · فصل ۴"], href: "/solvency-ruin", icon: ShieldCheck },
...
const titles: Record<ViewKey, { eyebrow: [string, string]; title: [string, string]; description: [string, string] }> = {
  portfolio: { eyebrow: ["Course dataset · Evidence before models", "داده‌های درس · شواهد پیش از مدل‌سازی"], title: ["Portfolio data and the five course models", "داده‌های پرتفوی و پنج مدل درسی"], description: ["The 1,000 synthetic months are the common input to every chapter. This page shows exactly what is observed, what is reconstructed, and how later formulas use it.", "هزار ماه مصنوعی، ورودی مشترک همهٔ فصل‌ها هستند. این صفحه دقیقاً نشان می‌دهد چه چیزی در دادهٔ منبع وجود دارد، چه چیزی بازسازی شده و فرمول‌های فصل‌های بعد چگونه از آن استفاده می‌کنند."] },
  risk: { eyebrow: ["Chapter 2 - Dr. Payandeh · Risk measurement", "فصل ۲ - دکتر پاینده · اندازه‌گیری ریسک"], title: ["VaR, TVaR, and the upper tail of loss", "ارزش در معرض ریسک، ارزش دنباله‌ای و بخش بالایی توزیع خسارت"], description: ["The controls change the confidence level p, loss variable X, and retention d in the chapter formulas. The charts compare empirical, normal, and EVT estimates on the same portfolio.", "کنترل‌ها سطح اطمینان p، متغیر خسارت X و حد نگهداری d را در فرمول‌های فصل تغییر می‌دهند. نمودارها برآورد تجربی، نرمال و نظریهٔ مقادیر حدی را روی یک پرتفوی مقایسه می‌کنند."] },
  utility: { eyebrow: ["Modern Actuarial Risk Theory · Chapter 1", "نظریهٔ مدرن ریسک بیمه‌ای · فصل ۱"], title: ["Utility, acceptable premium, and reinsurance", "مطلوبیت، حق‌بیمهٔ قابل‌قبول و بیمهٔ اتکایی"], description: ["This page applies the chapter's indifference-premium and stop-loss formulas to the portfolio, with risk aversion and retention exposed as model parameters.", "این صفحه فرمول‌های حق‌بیمهٔ بی‌تفاوتی و اتکایی مازاد خسارت را با نمایش صریح پارامترهای ریسک‌گریزی و حد نگهداری روی پرتفوی اعمال می‌کند."] },
  individual: { eyebrow: ["Modern Actuarial Risk Theory · Chapter 2", "نظریهٔ مدرن ریسک بیمه‌ای · فصل ۲"], title: ["From policy risks to aggregate loss", "از ریسک هر بیمه‌نامه تا خسارت کل"], description: ["Policy loss variables Xi are summed to form S. The comparison shows when convolution and moment approximations depend on the independence assumption.", "متغیرهای خسارت بیمه‌نامه‌ای Xᵢ با هم جمع می‌شوند تا S ساخته شود. مقایسه نشان می‌دهد پیچش و تقریب‌های گشتاوری در چه شرایطی به فرض استقلال وابسته‌اند."] },
  collective: { eyebrow: ["Modern Actuarial Risk Theory · Chapter 3", "نظریهٔ مدرن ریسک بیمه‌ای · فصل ۳"], title: ["Claim frequency, severity, and aggregate loss", "فراوانی خسارت، شدت خسارت و خسارت کل"], description: ["The collective model S = ΣXi combines a random count N with severities Xi. Frequency fit, severity choice, and numerical method are kept separate and visible.", "مدل جمعی S = ΣXᵢ تعداد تصادفی N را با شدت‌های Xᵢ ترکیب می‌کند. برازش فراوانی، انتخاب توزیع شدت و روش عددی به‌صورت جدا و شفاف نمایش داده می‌شوند."] },
  ruin: { eyebrow: ["Modern Actuarial Risk Theory · Chapter 4", "نظریهٔ مدرن ریسک بیمه‌ای · فصل ۴"], title: ["Surplus, solvency, and finite-horizon ruin", "مازاد، توانگری و ورشکستگی در افق محدود"], description: ["The surplus process Un links initial capital u, safety loading θ, retained aggregate loss Si, and the time horizon. Simulation and the Lundberg bound are not treated as interchangeable results.", "فرایند مازاد Uₙ سرمایهٔ اولیه u، ضریب اطمینان θ، خسارت کل نگهداری‌شده Sᵢ و افق زمانی را به هم مرتبط می‌کند. شبیه‌سازی و کران لوندبرگ به‌عنوان دو نتیجهٔ قابل‌جایگزینی ارائه نمی‌شوند."] },
  methodology: { eyebrow: ["Methodology · Sources, assumptions, and people", "روش‌شناسی · منابع، فرض‌ها و افراد"], title: ["How each result is produced and credited", "هر نتیجه چگونه تولید شده و به چه کسانی نسبت داده می‌شود"], description: ["Review the source lineage, reconstruction rules, result types, theoretical limits, and the students whose work contributes to each calculation.", "زنجیرهٔ داده، قواعد بازسازی، نوع نتایج، محدودیت‌های نظری و دانشجویانی را ببینید که کارشان در هر محاسبه نقش داشته است."] },
};
    ...
    <div className="app-shell">
      <aside className={`sidebar ${open ? "sidebar-open" : ""}`}>
        <div className="brand-row">
          <Link className="brand" href="/" aria-label={tr(language, "Risk Theory Lab home", "صفحهٔ اصلی آزمایشگاه نظریه ریسک")}>
